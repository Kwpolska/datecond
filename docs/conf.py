# -*- coding: utf-8 -*-
#
# Date Conditionals documentation build configuration file, created by
...
project = u'Date Conditionals'
copyright = u'2016-2020, Chris Warrick'
...
htmlhelp_basename = 'Date Conditionalsdoc'
...
latex_documents = [
  ('index', 'datecond.tex', u'Date Conditionals Documentation',
...
man_pages = [
    ('index', 'datecond', u'Date Conditionals Documentation',
     [u'Chris Warrick'], 1)
]
